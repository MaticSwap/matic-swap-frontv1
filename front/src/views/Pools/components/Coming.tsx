  ...
  return (
    <Card>
      <div style={{ padding: '24px' }}>
        ...
        <Button variant="secondary" as="a" href="https://t.me/maticswapchat" external width="100%" mb="16px">
        ...
        <DetailPlaceholder>
          <div style={{ flex: 1 }}>
            <img src="/images/farms/mswap.png" alt="MSWAP Token" width="15" height="15" />{' '}
