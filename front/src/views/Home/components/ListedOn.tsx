...
const ListedOn = () => {
  return (
    <StyledListedOn>
      <CardBody>
        <LinkListed>
          <a href="https://www.dapp.com/app/matic-swap" target="_blank" rel="noreferrer">
            <Image
        ...
        <LinkListed>
          <a href="https://dappradar.com/binance-smart-chain/defi/matic-swap" target="_blank" rel="noreferrer">
            <Image
